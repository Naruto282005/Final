<div class="space-y-6 animate-fade-in">
    ...
    <div class="card p-4">
        <div class="flex items-center gap-6">
            ...
            <button wire:click="setSortBy('discussed')" 
                            ...
                            @auth
                                @if(auth()->id() === $post->user_id)
                                    <div class="flex items-center gap-2" x-data="{ showDeleteConfirm: false }">
                                        ...
                                        {{-- Delete Button (quick delete with browser confirm) --}}
                                        <button type="button"
                                                x-on:click="if (confirm('Delete this post? This cannot be undone.')) { $wire.deletePost({{ $post->id }}); }"
